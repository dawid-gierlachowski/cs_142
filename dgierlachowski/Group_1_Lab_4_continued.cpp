...
int main()
{
	...
	const double federal_tax_rate = 0.15f;
	const double state_tax_rate = 0.03f;
	...
	double federal_tax_amount = gross_pay * federal_tax_rate;
	double state_tax_amount = gross_pay * state_tax_rate;
	double total_tax_amount = federal_tax_amount + state_tax_amount;
	
	// (8)  determine the net pay

	double net_pay = gross_pay - total_tax_amount;
